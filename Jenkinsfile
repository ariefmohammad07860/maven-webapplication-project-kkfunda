    ...
    tools
    {
     ...
     stages
     {
        stage('git checkout')
        {
          ...
          {
           //testing
             git branch: 'multi-branch', url: 'https://github.com/ariefmohammad07860/maven-webapplication-project-kkfunda.git'
          }
        } //stage  close
        stage('build')
        {
...
def notifyBuild(String buildStatus = 'STARTED') {
    ...
    slackSend(color: colorCode, message: summary, channel: '#bsnl-prod')
}
